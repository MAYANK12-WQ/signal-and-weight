...
beyond two Google Fonts) with seven exhibits:

| # | Exhibit | What you play with |
|---|---------|---------------------|
| 00 | **Glossary** | 48 flip-cards covering every core ML term, filterable by topic and searchable |
...
| 03 | **Inside a Neuron** | Drag two inputs and drag *directly on the weight lines* of a tiny neural network to watch every downstream neuron react live |
...
| 06 | **Putting It Together** | A simplified self-attention demo: tokenize a sentence, look up toy embeddings, click a word to see what it attends to |
...
straight there mid-lecture.

Exhibit 06 is a deliberately simplified teaching model of self-attention, not
a real trained transformer. For a full-fidelity, real-weights walk through
an actual GPT-2 model, see the excellent
